...
// Variables
const rootDomain = "homevpn.site"; // Ganti dengan domain utama kalian
const serviceName = "hpro"; // Ganti dengan nama workers kalian
  ...
  try {
    ...
    await tcpSocket.readable.pipeTo(
      new WritableStream({
        ...
        close() {
          log(`UDP connection to
          ${targetAddress} closed`);
        },
        abort(reason) {
